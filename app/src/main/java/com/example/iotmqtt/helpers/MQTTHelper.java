package com.example.iotmqtt.helpers;
...
public class MQTTHelper {
    ...
    final String serverUri = "tcp://hairdresser.cloudmqtt.com:16411";

    final String clientId = "AndroidClient1";
    final String subscriptionTopic = "temperature";
    final String subscriptionTopic2 = "leds";
    final String subscriptionTopic3 = "doorbell";

    final String username = "pkrqoggu";
    final String password = "j2qz4gfCubhL";
    ...
    private void subscribeToTopic() {
        ...
        try {
            mqttAndroidClient.subscribe(subscriptionTopic2, 2, null, new IMqttActionListener() {
                @Override
                public void onSuccess(IMqttToken asyncActionToken) {
                    Log.w("Mqtt","Subscribed!");
                }
